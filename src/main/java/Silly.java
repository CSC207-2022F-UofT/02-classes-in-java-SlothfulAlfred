...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * The name of this object is the concatenation of both strings.
     *
     * @param s1 the first string in this Silly instance's name
     * @param s2 the second string in this Silly instance's name
     */
